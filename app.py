...
def draw_wrapped_block(pdf, font, title, value, x, label_w, y, full_w):
    value = str(value).replace("\r", "").strip() if value else "-"
    ...
    text_w = full_w - label_w - 2
    if text_w < 30:
        text_w = 30

    pdf.set_xy(x + label_w, y)
    pdf.multi_cell(text_w, 6, value)
...
def build_pdf(quote: dict) -> bytes:
    ...
    def money_line(label, value, bold=False):
        ...
        pdf.cell(0, 7, f"{format_baht(value)} บาท", new_x="LMARGIN", new_y="NEXT", align="R")
    ...
    pdf.cell(0, 8, "ใบเสนอราคา / QUOTATION", new_x="LMARGIN", new_y="NEXT", align="C")

    pdf.set_font(font, "B", 14)
    pdf.cell(0, 7, STORE_NAME, new_x="LMARGIN", new_y="NEXT", align="C")

    pdf.set_font(font, "", 12)
    pdf.cell(0, 6, f"มือถือ/Line: {STORE_PHONE}", new_x="LMARGIN", new_y="NEXT", align="C")
    pdf.cell(0, 6, f"Website: {STORE_WEB}", new_x="LMARGIN", new_y="NEXT", align="C")
    ...
    pdf.cell(0, 7, doc_no, new_x="LMARGIN", new_y="NEXT")
    ...
    product_inner_x = left + 3
    product_inner_w = content_w - 6

    pdf.set_xy(product_inner_x, product_top + 3)
    pdf.set_font(font, "B", 13)
    pdf.multi_cell(product_inner_w, 6, safe_text(quote["section"]))

    pdf.set_x(product_inner_x)
    pdf.set_font(font, "", 12)
    pdf.multi_cell(product_inner_w, 6, f"Model: {safe_text(quote['model'])} | BTU: {quote['model_btu']:,}")
    ...
    product_bottom = pdf.get_y() + 3
    product_box_h = max(36, product_bottom - product_top)
    ...
    summary_bottom = pdf.get_y() + 3
    summary_h = max(28, summary_bottom - summary_y)
    ...
    pdf.cell(0, 8, "ลงชื่อผู้รับใบเสนอราคา .................................................", new_x="LMARGIN", new_y="NEXT")

    pdf.cell(85, 8, f"({STORE_NAME})", border=0, align="C")
    pdf.cell(10, 8, "", border=0)
    pdf.cell(0, 8, "(..............................................................)", new_x="LMARGIN", new_y="NEXT", align="C")

    pdf.cell(85, 8, "วันที่ ........../........../..........", border=0, align="C")
    pdf.cell(10, 8, "", border=0)
    pdf.cell(0, 8, "วันที่ ........../........../..........", new_x="LMARGIN", new_y="NEXT", align="C")
